...
class cyclepdf {
  static Future<File> generatepdf({
    ...
    required List<averagemodel> categories,
  }) async {
      ...
      build: (context) => [
        ...
        pw.Table.fromTextArray(
            ...
            columnWidths: {
              ...
              2: pw.FixedColumnWidth(PdfPageFormat.cm * 1),
            },
        ...
        pw.Container(
            ...
            child: pw.Row(children: [
              pw.Container(
                  width: PdfPageFormat.cm * 11.5,
                  padding: pw.EdgeInsets.symmetric(horizontal: 20),
                  child: pw.Text("اجمالي الوقت للقطعه",
              ...
              pw.Expanded(
                child: pw.Text(totaltime.toString(),
                    textAlign: pw.TextAlign.center,
                    style: pw.TextStyle(color: PdfColors.blue800)),
              )
            ]),
    ...
    return await savepdf("معدل  ${name}", pdf);
  }
