...
class editdialog extends StatelessWidget {
  final componentsmodel componentsmode;
  TextEditingController quantity = TextEditingController(text: "0");

  editdialog({super.key, required this.componentsmode});
              ...
              SizedBox(
                  ...
                  child: Container(
                      ...
                      child: SingleChildScrollView(
                          scrollDirection: Axis.vertical,
                          child: Column(children: [
                            Text('تعديل منتج ${componentsmode.name}',
                                style: TextStyle(
                            ...
                            BlocConsumer<componentCubit, componentState>(
                              ...
                              builder: (context, state) {
                                if (state is editcomponentloading)
                                  return loading();
                                return custommaterialbutton(
                                  ...
                                  onPressed: () async {
                                    BlocProvider.of<componentCubit>(context)
                                        .editcomponents(
                                            quantaity: int.parse(quantity.text),
                                            docid: componentsmode.name,
                                            type: true);
                                  },
                                );
                              },
