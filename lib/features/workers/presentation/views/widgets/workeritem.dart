...
class Workeritem extends StatelessWidget {
  final Workermodelrequest componentitem;
              ...
              children: [
                ...
                Text(" : ",
                    style: TextStyle(
                        ...
                        fontSize: 12.5,
                        color: appcolors.maincolor)),
                Text(componentitem.workhours.toString(),
                    style: TextStyle(
                        fontFamily: "cairo",
                        fontSize: 12.5,
                        color: appcolors.maincolor))
              ...
              children: [
                ...
                const Text(" : ",
                    style: TextStyle(
                        ...
                        color: appcolors.maincolor)),
                Expanded(
                  child: Text(componentitem.employment_date.toString(),
                      style: TextStyle(
                          fontFamily: "cairo",
                          fontSize: 12.5,
                          color: appcolors.maincolor)),
              ...
              children: [
                ...
                const Text(" : ",
                    style: TextStyle(
                        ...
                        color: appcolors.maincolor)),
                Expanded(
                  child: Text(componentitem.workhours.toString(),
                      style: TextStyle(
                          fontFamily: "cairo",
                          fontSize: 12.5,
                          color: appcolors.maincolor)),
